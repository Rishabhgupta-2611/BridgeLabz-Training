-- ================================================================
-- HEALTH CLINIC MANAGEMENT SYSTEM — COMPLETE DATABASE SCRIPT
-- Final Project — Day 4 (JDBC + MySQL)
-- ================================================================

DROP DATABASE IF EXISTS health_clinic_app_db;
CREATE DATABASE health_clinic_app_db;
USE health_clinic_app_db;
...
-- ----------------------------------------------------------------
-- 8. AUDIT LOG (populated via triggers — Day 3 concept)
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- 9. DEDICATED APPLICATION USER (Principle of Least Privilege — Day 1)
-- ----------------------------------------------------------------
